---
title: "tabooTransactions_s3b_preprocess"
author: "Dean"
...
df_s3b_raw <- read.csv("~/Google Drive/My Drive/taboo transactions/OSF materials/manuscript/data/df_s3b_raw.csv")
```
...
df_s3b <- df_s3b %>% 
  select(PID,
         cond,
         benefit_A:int_ratio,
         phone_int_choice:cncrt_benefit_B,
         ideo_gen:ideo_econ,
         SES,
         age,
         gender:race,
...
```{r}
write.csv(df_s3b,"~/Google Drive/My Drive/taboo transactions/OSF materials/manuscript/data/df_s3b.csv",row.names = F)
```
